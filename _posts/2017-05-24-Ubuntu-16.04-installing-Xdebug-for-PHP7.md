...
8. 修改php.ini加入這幾行就安裝完成了，現在可以透過編輯器來debug啦！

```bash
[xdebug]
zend_extension = /opt/lampp/lib/php/extensions/no-debug-non-zts-20160303/xdebug.so #路徑因人而異
xdebug.remote_autostart = 1
xdebug.remote_enable = 1
xdebug.remote_host = localhost
xdebug.remote_port = 9090  #port號隨你設
